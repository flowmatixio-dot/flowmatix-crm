...
export default function App() {
  ...
  const nav=isOperator?[
    ...
    "div",
    {id:"op_whatsapp",icon:"💬",l:"WhatsApp / Meta"},
    {id:"op_integrations",icon:"🔗",l:"Integrations"},
    {id:"op_automations",icon:"⚡",l:"Automations"},
    {id:"op_monitoring",icon:"📡",l:"Monitoring"},
    "div",
    {id:"op_logs",icon:"📋",l:"Logs"},
    {id:"op_api",icon:"🔑",l:"API & Secrets"},
    {id:"op_billing",icon:"💳",l:"Billing"},
    "div",
    {id:"op_security",icon:"🛡️",l:"Security"},
    {id:"op_infrastructure",icon:"🖥️",l:"Infrastructure"},
    {id:"op_support",icon:"🩺",l:"Support Toolkit"},
    "div",
