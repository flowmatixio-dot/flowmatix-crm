...
export default function App() {
  ...
  return(
    ...
    <div style={{display:"flex",height:"calc(100vh / 1.04)",background:"#0f1623",fontFamily:"'Plus Jakarta Sans',system-ui,sans-serif",color:"rgba(232,238,252,0.96)",overflow:"hidden"}}>
      ...
      <div style={{width:sidebar?260:68,minWidth:sidebar?260:68,background:"#131c2e",borderRight:"1px solid rgba(255,255,255,0.06)",display:"flex",flexDirection:"column",transition:"all .3s cubic-bezier(.4,0,.2,1)",overflow:"hidden"}}>
        ...
        <div style={{padding:sidebar?"14px 16px":"14px 10px",borderTop:"1px solid rgba(255,255,255,0.06)",flexShrink:0,marginTop:"auto",background:"#131c2e"}}>{sidebar?<div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}><div style={{display:"flex",alignItems:"center",gap:10}}><div style={{width:32,height:32,borderRadius:10,background:isAdmin?"rgba(76,201,255,0.1)":"rgba(16,185,129,0.1)",border:`1px solid ${isAdmin?"rgba(76,201,255,0.12)":"rgba(16,185,129,0.12)"}`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:13,fontWeight:700,color:isAdmin?"#4cc9ff":"#10b981"}}>{user.name.charAt(0)}</div><div><div style={{fontWeight:600,color:"rgba(232,238,252,0.8)",fontSize:13}}>{user.name}</div><div style={{fontSize:10,color:"rgba(167,177,195,0.35)",fontWeight:500}}>{isAdmin?"Admin":clinic?.name}</div></div></div><button onClick={handleLogout} style={{background:"rgba(255,255,255,0.04)",border:"1px solid rgba(255,255,255,0.06)",color:"rgba(167,177,195,0.5)",cursor:"pointer",fontSize:13,width:28,height:28,borderRadius:8,display:"flex",alignItems:"center",justifyContent:"center"}} title="Logout">↗</button></div>:<div onClick={handleLogout} style={{cursor:"pointer",textAlign:"center",color:"rgba(167,177,195,0.4)",fontSize:13,width:32,height:32,borderRadius:8,background:"rgba(255,255,255,0.04)",display:"flex",alignItems:"center",justifyContent:"center",margin:"0 auto"}}>↗</div>}</div>
      </div>
