...
const PIPELINE_COLS = [
  ...
  { id: 'ready', label: 'Ready', color: '#eab308', filter: c => c.workspace_state === 'activation_pending' || (c.workspace_state === 'live_test' && c.readiness_score >= 75 && c.required_action === 'NONE') },
...
export default function TrialsView({ actions }) {
  ...
  // Assign each clinic to first matching pipeline column
  ...
  const pipelineMrr = converted.reduce((s, c) => s + (c.mrr || 0), 0);
