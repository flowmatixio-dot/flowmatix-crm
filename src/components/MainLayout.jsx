...
export default function MainLayout() {
  ...
  return (
    ...
    <div style={{ display: "flex", height: "100dvh", background: "#0f1623", fontFamily: "'Plus Jakarta Sans',system-ui,sans-serif", color: "rgba(232,238,252,0.96)", overflow: "hidden", ...(ctx.workspaceState === 'trial_expired' || ctx.showPlanPicker ? { filter: "blur(3px)", pointerEvents: "none" } : {}) }}>
