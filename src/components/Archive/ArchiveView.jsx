...
export default function ArchiveView() {
  ...
  const archived = useMemo(() => {
    ...
    return myLeads.filter(lead => {
      ...
      const archiveStages = ["cancelled", "archived", "storniert", "abgeschlossen", "canceled"];
      return archiveStages.includes(lead.stage) || lead.metadata?.cancelled || lead.archived || lead.conversation_state === "resolved";
    }).sort((a, b) => {
