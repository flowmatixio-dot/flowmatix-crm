...
export default function AuditLogView() {
  ...
  return <div style={{padding:28,maxWidth:960}}>
    ...
    <div style={{borderRadius:14,overflow:"hidden",border:"1px solid rgba(255,255,255,0.08)"}}>
      ...
      {auditLog.length===0&&<div style={{padding:40,textAlign:"center",color:"rgba(167,177,195,0.3)"}}>{t("no_audit_events")}</div>}
    ...
    {auditLog.length>100&&<div style={{padding:12,textAlign:"center",fontSize:12,color:"rgba(167,177,195,0.4)"}}>{t("showing_latest_100_of")} {auditLog.length} {t("events_export_csv")}</div>}
    {/* RLS Note */}
